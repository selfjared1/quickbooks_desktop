import logging
import html
from dataclasses import field, is_dataclass, fields, dataclass
from collections import defaultdict
import xml.etree.ElementTree as ETree
from xml.sax.saxutils import unescape

import src.quickbooks_desktop.qb_common.qb_common_fields
from .qb_common.qb_common_dicts import yes_no_dict
from .qb_common.qb_common_fields import TempVar, list_id, list_ids, full_name, full_names, amount
from .qb_common.qb_common_lists import VALID_TXN_DATA_EXT_TYPE_VALUES, VALID_LIST_DATA_EXT_TYPE_VALUES, \
    VALID_TXN_TYPE_VALUES, VALID_REPORT_TXN_TYPE_VALUES, VALID_OPERATOR_VALUES, VALID_RELATION_VALUES, \
    VALID_ACCOUNT_TYPE_VALUES, VALID_DETAIL_ACCOUNT_TYPE_VALUES, VALID_SPECIAL_ACCOUNT_TYPE_VALUES, \
    VALID_CASH_FLOW_CLASSIFICATION_VALUES, VALID_REPORT_ACCOUNT_TYPE_VALUES, VALID_REPORT_ITEM_TYPE, \
    VALID_SUMMARIZE_ROWS_BY, VALID_SUMMARIZE_COLUMNS_BY, VALID_INCLUDE_COLUMN_VALUES, VALID_REPORT_DETAIL_LEVEL_FILTERS, \
    VALID_REPORT_POSTING_STATUS_FILTER, VALID_RETURN_ROWS, VALID_REPORT_CALENDAR, VALID_RETURN_COLUMNS, \
    VALID_REPORT_BASIS, VALID_COL_TYPE_VALUES, VALID_ROW_DATA_ROW_TYPE_VALUES, VALID_COL_DATA_DATA_TYPE_VALUES, \
    VALID_GENERAL_SUMMARY_REPORT_TYPE_VALUES, VALID_GENERAL_DETAIL_REPORT_TYPE_VALUES, VALID_AGING_REPORT_TYPE_VALUES, \
    VALID_PAYROLL_DETAIL_REPORT_TYPE_VALUES, VALID_REPORT_DATE_MACRO_VALUES
from .qb_special_fields import *
from .utilities import encode_special_characters
from functools import cached_property
import pandas as pd
from decimal import Decimal, ROUND_HALF_UP
from typing import List, Any, Optional, Type, get_origin, get_args
...
class CreateAddOrModFromParentMixin:
    ...
    def _create_inventory_adjustment_line_add(self, inventory_adjustment_line):
        ...
        self.item_ref.full_name = src.quickbooks_desktop.qb_common.qb_common_fields.full_name
...
class PluralListMixin:
    ...
    def save_all(self, qb, raw_response=False):
        xml_requests = []
        for item in self:
            if src.quickbooks_desktop.qb_common.qb_common_fields.list_id is not None:
        ...
        for attr_name in dir(obj):
            if attr_name.startswith('__'):
                ...
                if hasattr(ref, id_name):
                    src.quickbooks_desktop.qb_common.qb_common_fields.list_id = None
                else:
                    pass
            else:
